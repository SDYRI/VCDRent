...
namespace VCDRent.Controllers
{
    [Authorize(Roles = VCDRent.MVC.Pages.ApplicationUser.Role)]
    public class ApplicationUserController : Controller
    {
        ...
        {
            ApplicationUser cekAdmin = await _userManager.GetUserAsync(User);

            if (cekAdmin.isSuperAdmin)
            {
